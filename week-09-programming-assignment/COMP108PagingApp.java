...
class COMP108PagingApp {
	...
	private static final int NoEvict = 1;
	private static final int EvictLRU = 2;
	...
	public static void main(String[] args) throws Exception {
		...
		if (algorithmChoice == AllAlg || algorithmChoice == NoEvict) {
			try {
				System.out.println();
				System.out.println("noEvict");
				copyArray(orgCache, cache, cacheSize);
				output = COMP108Paging.noEvict(cache, cacheSize, request, requestSize);
